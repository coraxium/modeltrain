...
void resetConfiguration()
{
  ...
  // Setzt den ganzen beschriebene Bereich zurück auf 0xff
...
/**
 * Displays the the stored data on serial port connected terminal.
 */
...
void readConfiguration()
{
  ...
  // Jetzt die Bytes aus dem statischen Config-Bereich lesen
